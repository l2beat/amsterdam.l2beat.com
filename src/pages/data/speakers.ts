...
export const speakers: Speaker[] = [
  ...
  },
  {
    ...
    image: '/images/speakers/aleksandr-vlasov.jpg',
  },
  {
  ...
  },
  {
    name: 'Julien Niset',
    company: 'Argent',
    bio: 'Julien is the Chief Science Officer and co-founder of Argent. He holds a PhD in Physics from Université libre de Bruxelles with a focus on Quantum Information and Quantum Cryptography. He has authored several publications in leading peer reviewed scientific journals and is the author of three patents: for quantum random number generation, distribution and use in novel cryptographic schemes.',
  ...
  },
  {
    name: 'Ben Jones',
    company: 'Optimism',
    bio: 'Ben "Weird ETH Yankovic" Jones is a co-founder and Chief Scientist at Optimism. Prior to Optimism he worked on Ethereum\'s CBC Casper team.  In his free time he works on crypto music.',
    image: '/images/speakers/ben-jones.jpg',
  },
  {
    name: 'Chaitanya Konda',
    company: 'EY',
    bio: "Chaitanya is a Cryptography and Blockchain Researcher working in EY's Blockchain R&D team. She works on scalable privacy solutions for public blockchains. She led the development of Nightfall 1 project and currently is leading the deployment of Polygon Nightfall to mainnet in partnership with Polygon.",
    image: '/images/speakers/chaitanya-konda.jpg',
  },
  {
    name: 'Daniel Kmak',
    company: 'Nervos',
    bio: 'Blockchain developer at Nervos. Currently focused on UTXO-blockchains and EVM rollups. In the space since 2017. Previously worked for Ethereum Alarm Clock, Polymath, Energy Web Foundation.',
    image: '/images/speakers/daniel-kmak.jpg',
  },
  {
    name: 'Emily Herbert',
    company: 'Fuel Labs',
    bio: 'Emily is a compiler engineer at Fuel Labs, working on the Sway compiler. She holds a MS in Computer Science from the University of Massachusetts Amherst and was a PhD student at Northeastern University (before she dropped out), where she specialized in programming languages and compilers work. Before joining Fuel Labs, Emily spent time at both Google and NASA, focusing on combining the domains of programming languages and networking.',
    image: '/images/speakers/emily-herbert.jpg',
  },
  {
    name: 'Hadrien Croubois',
    company: 'OpenZeppelin',
    bio: 'Hadrien is French, has a Ph.D. in computer science from the École Normale Supérieure de Lyon, and has been working as a smart-contracts engineer since 2017. Currently he is a part of the OpenZeppelin development team, working on the open-source smart-contracts library and the associated tooling.',
    image: '/images/speakers/hadrien-croubois.jpg',
  },
  {
    name: 'Jacob Caban-Tomski',
    company: 'Ethereum Foundation',
    bio: 'Developer working on scaling solutions using L2s for Ethereum to lower costs and enable more people from around world to participate and enjoy the benefits of using Web3.',
    image: '/images/speakers/jacob-caban-tomski.jpg',
  },
  {
    name: 'Jordi Baylina',
    company: 'Polygon',
    bio: 'Jordi leads the technical development of the Polygon Hermez zkRollup and is currently working on the implementation of the zkEVM. He is the co-founder of the White Hat Group, the author of the MiniMe token contract, the elliptic curves Solidity library, as well as numerous other established contracts in the Ethereum space. Jordi is also a well-respected auditor as well as the co-founder of the donation platform Giveth, DAppNode, Iden3 and most recently, Polygon Hermez.',
    image: '/images/speakers/jordi-baylina.jpg',
  },
  {
    name: 'Olivier Begassat',
    company: 'ConsenSys',
    bio: 'Olivier Bégassat is part of the ConsenSys Applied Research RnD team. His current interest is around developping a zk-evm.',
    image: '/images/speakers/olivier-begassat.jpg',
  },
  {
    name: 'Théodore Chapuis-Chkaiban',
    company: 'ConsenSys',
    bio: 'Theodore Chapuis-Chkaiban is an applied researcher in Cryptography at ConsenSys Protocols R&D team. His research interests lie at the intersection of cryptography and computer architecture design. He is the co-author of a paper recently published on EthResearch specifying a model for a zk-EVM which is currently being implemented.',
    image: '/images/speakers/theodore-chapuis-chkaiban.jpg',
  },
  {
    name: 'Vitaly Yakovlev',
    company: 'ZKX',
    bio: 'Vitaly is the CTO at ZKX, where he leads all aspects of the technology and innovation of a suite of Web3 products. He is a strategic, business-driven leader with 20+ years of experience and specializes in developing operational strategies to assure business growth through emerging technologies and product-market-fit.',
    image: '/images/speakers/vitaly-yakovlev.jpg',
  },
  {
    name: 'Alex Gluchowski',
    company: 'zkSync',
    bio: 'Alex is a software architect with over 15 years of experience in engineering and startups. Currently, he is a co-founder at Matter Labs, an R&D company on a mission to solve blockchain scalability challenge with zero-knowledge proofs. Alex is deeply passionate about individual freedom, self-ownership and decentralization.',
    image: '/images/speakers/alex-gluchowski.jpg',
  },
  {
    name: 'Joe Andrews',
    company: 'Aztec',
    bio: 'Joe is the Head of Product and Co-founder at Aztec. He wears many hats but mainly focuses on helping developers build out bridge interactions, the Aztec SDK and building zk.money.',
    image: '/images/speakers/joe-andrews.jpg',
  },
  {
    name: 'Faina Shalts',
    company: 'ConsenSys',
    bio: 'Faina Shalts is a Lead Blockchain Engineer at ConsenSys. Since joining in 2018, she has worked on Truffle’s open source tool suite. She now leads the Layer 2/Scaling team at Truffle, seeking to make Layer 2 adoption as easy as possible for developers.',
    image: '/images/speakers/faina-shalts.jpg',
  },
  {
    name: 'Bartek Kiepuszewski',
    company: 'L2BEAT',
    bio: 'Bartek Kiepuszewski is a Blockchain Researcher working for MakerDAO Protocol Engineering team where he is primarily responsible for risk assessment  of various scaling solutions for Ethereum. He is also a co-founder of l2beat.com, the community-focused, vendor-neutral portal educating users about Ethereum Layer2 ecosystem.',
    image: '/images/speakers/bartek-kiepuszewski.jpg',
  },
]
